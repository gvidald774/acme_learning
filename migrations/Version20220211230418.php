 ...
 */
final class Version20220211230418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD genero enum(\'m\',\'f\',\'x\')');
    }
