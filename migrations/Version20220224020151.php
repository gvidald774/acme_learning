 ...
 */
final class Version20220224020151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plaza ADD texto LONGTEXT DEFAULT NULL, DROP documentos');
        $this->addSql('ALTER TABLE user CHANGE genero genero enum(\'m\',\'f\',\'x\')');
        // BASTA YA DEJA EL GÉNERO TRANQUILO COÑO
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plaza ADD documentos LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', DROP texto, CHANGE estado estado VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
