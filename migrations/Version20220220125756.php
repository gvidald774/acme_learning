 ...
 */
final class Version20220220125756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE curso CHANGE imagen imagen VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE foto foto VARCHAR(255) DEFAULT NULL, CHANGE genero genero enum(\'m\',\'f\',\'x\')');
    }
