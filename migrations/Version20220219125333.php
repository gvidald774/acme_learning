 ...
 */
final class Version20220219125333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE curso ADD imagen LONGBLOB NOT NULL');
